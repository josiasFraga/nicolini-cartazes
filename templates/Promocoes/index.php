...
<div class="row buttons-container">
    ...
    <?= $loja_selecionada == '011' || $loja_selecionada == '001' || $loja_selecionada == '013' || $loja_selecionada == '017' || $loja_selecionada == '022' ? $this->Form->button('Exeterna', ['id' => 'livramento-button', 'onclick' => 'event.preventDefault(); goToLivramento();', 'class' => 'button-outline ' . $livramento_externas]) : ''; ?>
</div>
