...
<div class="row buttons-container">
    ...
    <?= $loja_selecionada == '011' || $loja_selecionada == '001' || $loja_selecionada == '013' || $loja_selecionada == '017' || $loja_selecionada == '022' ? $this->Form->button('Externa', ['id' => 'livramento-button', 'onclick' => 'event.preventDefault(); goToLivramento();', 'class' => 'button-outline ' . $livramento_externas]) : ''; ?>
</div>
    ...
    <tbody>
        <?php foreach ($promocoes as $promocao): ?>
            ...
            $tamanho_cartaz_options = [
                ...
                'A3HD' => 'A3 Horizontal Duplo (29,7x42cm)',
                'A4' => 'A4 (21x29,7cm)', 
            ...
            if ( in_array($loja_selecionada, ['001', '011', '013', '017', '026']) && in_array($promocao->tipoCartaz, ['Normal Novo', 'Clube Novo', 'De Por Novo', 'Desconto Qtd Min Novo']) ) {
