...
.page.cashback .item_header img { max-width: 80% !important; margin: 0 auto !important}
            ...
            <div class="item_price_inner">
                ...
                <div class="item_price_to">
                    <div class="item_price_to_price">
                        <?= number_format($promocao->VlrVenda * 0.1, 2, ',', '.') ?>
                    </div>
                </div>
                <div class="desconto_desc">
