...
<div class="item_container vertical <?= $dados_loja['class'] ?>">
    ...
    <div class="item_header <?= $dados_loja['class'] ?>">
        <?php if (empty($tema)) : ?>
        <?= $this->Html->image('clube/atacadao_vertical.png', ['fullBase' => true]); ?>
        <?php endif; ?>
        <?php if (!empty($tema)) : ?>
    ...
    <div class="bs_flex bs_column" style="flex: 1">

        <div class="product_name bs_text_center font_lilita_one">
            <?= $promocao->descricao_impressao ?>
        </div>
            
        <div class="price_from bs_row bs_justify_center bs_align_flex_end font_lilita_one" style="flex: none">
            <span class="money_label">R$</span>
            <?= $VlrVenda ?>
            <span class="unit"><?= $promocao['un_medida'] ?></span>
        </div>
    ...
    <div class="bs_flex bs_column" style="flex: 1">
        <div class="bs_flex" style="flex: 1">
            <div class="desconto_desc bs_text_center font_lilita_one">
                Desconto por cliente<br>em at&eacute;
