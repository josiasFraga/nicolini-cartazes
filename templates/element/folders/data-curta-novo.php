...
<div class="item_container" style="position: relative;">
    ...
    <div class="item_header <?= $dados_loja['class'] ?> <?= $promocao->horti == "-1" ? "horti" : "" ?>"<?= !empty($tema) ? ' style="padding: 0 !important;"' : '' ?>>
        <?php if (empty($tema)) : ?>
    ...
    <div class="bs_row" style="flex: unset;">
        ...
        <?php if ($dados_loja['class'] == "atacadao"): ?>
            <div class="float_logo">
                <?= $this->Html->image("data-curta-novo/logo-atacadao.png", ['fullBase' => true]); ?>
            </div>
        <?php endif; ?>
    </div>
</div>